...
import cart.application.exception.dto.ErrorMessage;
import cart.domain.exception.CartApiException;
...
public class GlobalExceptionHandler {
    ...
    public ErrorMessage handleCartApiException(CartApiException ex) {
        return new ErrorMessage(ex.getMessage());
    }
